...
RSpec.describe Database do
  ...
  it 'returns the correct employee information' do
    result = db.search_employee('John Doe', 'Company A', 'Dept 1', 'Group A', 'Lab 1', 'Engineer', 12345, 6789)
  ...
  it 'handles no results gracefully' do
    result = db.search_employee('Non Existent', nil, nil, nil, nil, nil, nil, nil)
